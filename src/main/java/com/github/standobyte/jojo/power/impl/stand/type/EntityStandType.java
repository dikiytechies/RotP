        ...
        if (!user.level.isClientSide()) {
            power.getStandInstance().ifPresent(standInstance -> {
                if (!standInstance.hasPart(StandPart.ARMS)) {
                    user.addEffect(new EffectInstance(Effects.WEAKNESS, 319, 1, false, false, true));
                    user.addEffect(new EffectInstance(Effects.DIG_SLOWDOWN, 319, 1, false, false, true));
                }
                if (!standInstance.hasPart(StandPart.LEGS)) {
                    user.addEffect(new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 319, 1, false, false, true));
                }
            });
        }
    }
